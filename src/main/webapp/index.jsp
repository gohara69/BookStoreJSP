	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"> <img
				src="https://cdn.codegym.vn/wp-content/uploads/2021/08/CodeGym-Logo.webp"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<%if(khachHang == null){ %>
						<a class="btn btn-primary ms-1" style="white-space: nowrap;" href="khachhang/sign-in.jsp">Đăng nhập</a>
					<%} else {%>
						<div class="bg-infor ms-1">
							<a class="nav-link dropdown-toggle d-inline-block" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Tài khoản </a>
							<ul class="dropdown-menu dropdown-menu-end">
								<li><a class="dropdown-item" href="#">User information</a></li>
								<li><a class="dropdown-item" href="change-password.jsp">Change information</a></li>
